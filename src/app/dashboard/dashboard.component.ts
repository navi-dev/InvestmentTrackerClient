...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    // console.log(this.adal.accessToken);
    // console.log(this.adal.userInfo);
    // console.log(this.adal.GetResourceForEndpoint('http://localhost:50466'));
    // console.log(this.adal.acquireToken('http://localhost:50466'))
